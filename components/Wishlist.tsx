import { Heart, ShoppingCart, CheckCircle2, XCircle } from "lucide-react";
        ...
        {items.map((item) => (
          ...
          >
            ...
            <button
              ...
              className={`relative flex items-center justify-center gap-2 overflow-hidden rounded-xl px-5 py-3 md:w-auto w-full text-sm font-semibold transition-all duration-300 ${
                item.inStock
